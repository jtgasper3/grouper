...
public class GrouperAdobeAuth {
  
  public GrouperAdobeAuth() {
  }
   ...
   * @param database
   */
  public static void createTableAdobeAuth(DdlVersionBean ddlVersionBean, Database database) {

    final String tableName = "mock_adobe_auth";
