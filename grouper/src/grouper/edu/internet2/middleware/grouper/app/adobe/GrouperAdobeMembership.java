...
public class GrouperAdobeMembership {

  /**
   * @param ddlVersionBean
   * @param database
   */
  public static void createTableAdobeMembership(DdlVersionBean ddlVersionBean, Database database) {

    final String tableName = "mock_adobe_membership";
    ...
    try {
      ...
      GrouperDdlUtils.ddlutilsFindOrCreateIndex(database, tableName, "mock_adobe_mship_gid_idx", false, "group_id");
